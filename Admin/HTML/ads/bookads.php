...
if(isset($_POST['submitbutton'])){
	if($_POST['adsname'] =="" || $_POST['Quantity'] =="" ||$_POST['Author'] =="" ||$_POST['Bookname'] =="" ||$_POST['Price'] ==""  ||$_POST['bookType'] =="" ||$_POST['Publisher'] =="" ){
...
echo '<script>window.alert("one or more field are requeried")</script>';
	...
	$adsobj->category='Book';
	$adsobj->Description= $_POST['Description'];
	
	$bookobj= new book;
	$bookobj->Author = $_POST['Author'];
	$bookobj->bookname = $_POST['Bookname'];
	$bookobj->Publisher = $_POST['Publisher'];
	$bookobj->Price = $_POST['Price'];
	$bookobj->Type= $_POST['bookType'];
	
	$controlobj = new Controler;
	$controlobj->createAds($adsobj,$bookobj,null,null,null,1);
    ...
    <option value="bookads.php">book</option>
     <option value="mobileads.php">mobile</option>
       ...
       <form id="create" method="post" >
         <font face="fantasy" color="#33817f" size="5" >
         <center> Advertisement for Book </center>
...
<br>
         ...
         <input type="text" name="Bookname" style=" height:20px; width:200px; " > 
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;
         <input type="text" name="Author" style=" height:20px; width:200px; " > <br>
         ...
         <input type="text" name="Price" style=" height:20px; width:200px; " > 
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;
         <input type="text" name="Publisher" style=" height:20px; width:200px; " > <br>
          &nbsp;&nbsp;&nbsp;&nbsp; Type :					
          <br>&nbsp;&nbsp;&nbsp;&nbsp;
         <input type="text" name="bookType" style=" height:20px; width:200px; " > 
