...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	...
	<body bgcolor="#ffffff" id="body">
	 ...
	 require_once('../Advertisement.php');
	  require_once('../mobile_class.php');
	   require_once('../../Controler.php');
	  
if(isset($_POST['submitbutton'])){
	if($_POST['adsname'] =="" || $_POST['Quantity'] =="" ||$_POST['Price'] =="" ||$_POST['Screen'] =="" ||$_POST['CPU'] ==""  ||$_POST['manefactor'] =="" ||$_POST['Ram'] =="" ){
echo '<script>window.alert("one or more field are requeried")</script>';
	...
	$adsobj->category='Mobile';
	$adsobj->Description= $_POST['Description'];
	
	$mobobj= new mobile;
	$mobobj->screen = $_POST['Screen'];
	$mobobj->cpu = $_POST['CPU'];
	$mobobj->manfactor = $_POST['manefactor'];
	$mobobj->price = $_POST['Price'];
	$mobobj->ram = $_POST['Ram'];
	
	$controlobj = new Controler;
	$controlobj->createAds($adsobj,null,null,$mobobj,null,3);
    ...
    <option value="bookads.php">book</option>
     <option value="mobileads.php">mobile</option>
       ...
       <form id="create" method="post" >
         <font face="fantasy" color="#33817f" size="5" >
         <center> Advertisement for Mobile </center>
...
<br>
         ...
         <input type="text" name="Ram" style=" height:20px; width:200px; " > 
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;
         <input type="text" name="CPU" style=" height:20px; width:200px; " > <br>
         ...
         <input type="text" name="Price" style=" height:20px; width:200px; " > 
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;
         <input type="text" name="manefactor" style=" height:20px; width:200px; " > <br>
          &nbsp;&nbsp;&nbsp;&nbsp; Screen :					
          <br>&nbsp;&nbsp;&nbsp;&nbsp;
         <input type="text" name="Screen" style=" height:20px; width:200px; " > 
